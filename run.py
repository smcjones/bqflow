...
def main():
  ...
  parser = argparse.ArgumentParser(
    ...
    description=textwrap.dedent("""\
      ...
      This script dispatches all the tasks in a yaml workflow to handlers in sequence.
      For each task, it calls a subprocess to execute the yaml instructions, waits
  ...
  parser.add_argument('workflow', help='Path, local or Google Drive link, to workflow yaml file to run.')
  ...
  parser.add_argument('--client', '-c', help='Path to CLIENT credentials yaml file.', default=None)
